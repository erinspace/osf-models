# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-08-17 00:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('_guid', models.ForeignKey(blank=True, default=osf_models.models.base.generate_guid_instance, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='osf_models.Guid')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='comment',
            name='_guid',
            field=models.ForeignKey(blank=True, default=osf_models.models.base.generate_guid_instance, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='osf_models.Guid'),
        ),
        migrations.AddField(
            model_name='comment',
